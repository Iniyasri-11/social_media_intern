...
/* ==================================================================
   PULSE — social auth experience (Register)
=================================================================== */
...
export default function RegisterPage() {
  ...
  const usernameLooksValid = username.trim().length >= 3 && !/\s/.test(username);
  const usernameStatus =
    status === "error" && !username.trim()
      ? "error"
      : usernameTouched && username.trim() && !usernameLooksValid
      ? "error"
      : usernameTouched && usernameLooksValid
      ? "success"
      : null;
  const usernameHint =
  ...
  const phoneLooksValid = phoneNumber.trim().length >= 10;
  const phoneStatus =
    status === "error" && !phoneNumber.trim()
      ? "error"
      : phoneTouched && phoneNumber.trim() && !phoneLooksValid
      ? "error"
  ...
  const pwLooksValid = password.length >= 8;
  const pwStatus =
    status === "error" && !password
      ? "error"
      : pwTouched && password && !pwLooksValid
      ? "error"
      : pwTouched && pwLooksValid
      ? "success"
      : null;
  const pwHint =
    pwStatus === "error"
  ...
  const confirmStatus =
    status === "error" && !confirmPassword
      ? "error"
      : confirmTouched && confirmPassword && !confirmMatches
      ? "error"
  ...
  const handleSubmit = async (e) => {
    ...
    setLoading(true);
    try {
      await register(username, password, { phone_number: phoneNumber, username });
      setStatus("success");
  ...
  return (
    ...
    >
      ...
      {/*
        ...
        hero copy and the register card, so there's no seam where the two
      ...
      */}
      ...
      >
        ...
        {/* Soft pulsing accent glow, positioned to sit behind the register card */}
        <div
          ...
          >
            <div style={{ position: "relative", zIndex: 1 }}>
              <div style={{ marginBottom: "1.75rem" }}>
                ...
                >
                  Join Pulse and start connecting today.
                </p>
              </div>
              ...
              >
                <FloatingLabelInput
                  ...
                  onBlurValidate={() => setUsernameTouched(true)}
                ...
                <FloatingLabelInput
                  ...
                  onBlurValidate={() => setPhoneTouched(true)}
                  status={phoneStatus}
                  hint={phoneHint}
                />
                ...
                <FloatingLabelInput
                  ...
                  onBlurValidate={() => setConfirmTouched(true)}
                ...
                >
                  ...
                  />
                  <span>
                    I agree to the <a href="#terms" className="link-underline">Terms of Service</a> and{" "}
